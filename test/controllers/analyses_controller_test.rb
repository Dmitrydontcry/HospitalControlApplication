...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference("Analysis.count") do
      post analyses_url, params: { analysis: { description: @analysis.description, files: @analysis.files, name: @analysis.name } }
    end
  ...
  test "should update analysis" do
    patch analysis_url(@analysis), params: { analysis: { description: @analysis.description, files: @analysis.files, name: @analysis.name } }
