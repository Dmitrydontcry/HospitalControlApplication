...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference("Attachment.count") do
      post attachments_url, params: { attachment: { data: @attachment.data, name: @attachment.name } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { data: @attachment.data, name: @attachment.name } }
